...
use LDL\Http\Router\Plugin\LDL\Auth\Procedure\Credentials\AuthCredentialsProcedure;
...
$providers->append(new AuthCredentialsProcedure(new PlainFileCredentialsProvider('../users.txt'), 'user', 'password'));
